...
if(isset($_POST['submit'])){
  ...
  $upwd=$_POST['upwd'];
  $c=md5($upwd);
  $data=mysqli_query($db,"select * from users where semail='$uemail' and spass='$c'");
    ...
    <section id="contact" class="contact">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row mt-5">
          ...
          <center>
          <h6 class="text-danger pt-3">Login</h6>
          <div class="col-lg-4 mt-5 mt-lg-0">

            <form action="login.php" method="post" role="form" class="">
