    ...
    <section id="contact" class="contact">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row mt-2">
          ...
          <h6 class="text-danger pt-3">Registration</h6>
            <form id="register_form" method="post" action="register_user.php">
              ...
              <div class="form-group mt-3">
                <input type="text" class="form-control" name="rno" placeholder="Roll No" required="true">
              </div>
              <div class="form-group mt-3">
                <input type="text" class="form-control" name="email" placeholder="Email" required="true">
              </div>
              <div class="form-group mt-3">
                <input type="text" class="form-control" name="phone" placeholder="Phone No." required="true">
              </div>
              <div class="form-group mt-3">
                <input type="password" class="form-control" name="password" id="pass1" placeholder="Password" required="true">
              </div>
              <div class="form-group mt-3">
                <input required="true" type="password" class="form-control" name="cpassword" placeholder="Confirm Password" id="pass2"
                            onkeyup="checkPass()" >
