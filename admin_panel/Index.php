            ...
            <div class="container ">
             ...
             <div class="row">
               ...
               <div class="col-lg-6">
                ...
                <div class="card text-white  mb-3 p-5" style="max-width: 100%; background-color: rgb(211, 164, 35);">
                  <div class="card-header">Dashboard</div>
                  <div class="card-body">
                   
                    <p class="card-text">Click Here to Check Dashboard.</p>
                  </div>
                </div>
                
                <div class="card text-white mb-3 p-5" style="max-width: 100%; background-color: rgb(150, 175, 59);">
                  <div class="card-header">All Students</div>
                  <div class="card-body">
                  
                    <p class="card-text">We have to show details of our college Students.</p>
                  </div>
               </div>
             ...
             <div class="col-lg-6">
              ...
              <div class="card text-white  mb-3 p-5" style="max-width: 100%;background-color: rgb(150, 175, 59);">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">We have to add new student in this Page.</p>
                </div>
              </div>
              ...
              <div class="card text-white mb-3 p-5" style="max-width: 100%; background-color: rgb(211, 164, 35);">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">We have to check, Edit and Delet this all product.</p>
                </div>
             </div>
