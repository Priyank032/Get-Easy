...
{
    $rno=$_POST['id']; 
    $res=mysqli_query($db,"select * from col_users where uid='$rno'");
...
if(isset($_POST['submit']))
{
    ...
    $sql = "update col_users set urno = '$rno',uname='$name',uemail='$email',ucourse='$course' where urno = '$rno'";
      ...
      <nav>
        ...
        <div class="mainadd">
            <div class="container ">
                ...
                <h2 class="text-center pt-5">Update Student</h2>
                <hr>
                    ...
                    <div class="col-lg-7">
                        <form action="edit_student.php" method="post">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text"   name="name" class="form-control" value="<?php echo $row1['uname']; ?>" id="formGroupExampleInput" placeholder="Name">
                            </div>
                            <div class="form-group">
                              <label for="formGroupExampleInput2">Email</label>
                              <input type="text" name="email" class="form-control" value="<?php echo $row1['uemail']; ?>" id="formGroupExampleInput2" placeholder="Email">
                            </div>
                            <div class="form-group">
                                <label for="formGroupExampleInput">Enroll No.</label>
                                <input type="text" readonly="true" name="rno" class="form-control" value="<?php echo $row1['urno']; ?>" id="formGroupExampleInput" placeholder="Roll No.">
                              </div>
                              <div class="form-group">
                                <label for="formGroupExampleInput2">Course</label>
                                <input type="text"  name="course" class="form-control" value="<?php echo $row1['ucourse']; ?>" id="formGroupExampleInput2" placeholder="Course ">
                              </div>
                              <button type="submit" id="submit" name="submit" class="btn btn-success btn-lg m-4" >Save</button>
                          </form>
                    </div>
                </div>
