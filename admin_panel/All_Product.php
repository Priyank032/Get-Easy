      ...
      <nav>
        ...
        <div class="mainadd">
            <div class="container ">
                ...
                <h2 class="text-center pt-5">All Products</h2>
                <!-- <div id="toolbar">
                ...
                <table id="table" data-toggle="table" data-search="true" data-filter-control="true"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-field="Item Name" data-filter-control="input" data-sortable="true">Item Name</th>
                            <th data-field="Item Image" data-filter-control="input" data-sortable="true">Item Image</th>
                            <th data-field="Item Price" data-filter-control="input" data-sortable="true">Item Price</th>
                            <th data-field="Item Quantity" data-filter-control="input" data-sortable="true">Item Quantity</th>
                  
                            
                            <th data-field="Item Condition" data-filter-control="input" data-sortable="true">Item Condition</th>
                            <th data-field="Description" data-filter-control="input" data-sortable="true">Description</th>
                           
                            <th data-field="Seller Name" data-filter-control="input" data-sortable="true">Seller Name</th>
                            <th data-field="Seller Mail" data-filter-control="input" data-sortable="true">Seller Mail</th>
                            <th data-field="Seller Contact" data-filter-control="input" data-sortable="true">Seller Contact</th>
              ...
              while( $row = mysqli_fetch_array($result))
              {
                ?>
                        <tr>
                            ...
                            <td><?php  echo "<img class='w-100 card-img-top'' src='../products_images/$row[2]'>"; ?></td>
