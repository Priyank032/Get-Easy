    ...
    <section class="home-section">
        ...
        <div class="mainadd">
            <div class="container ">
                ...
                <h2 class="text-center pt-5">Insert Student</h2>
                <hr>

                <div class="row">
                    <div class="col-lg-5">
                        <form class="form-horizontal well" action="add_user.php" method="post" name="upload_excel"
                            enctype="multipart/form-data">

                            <legend>Import CSV <span style="color:red">/</span> Excel file
                                <a href="./Book1.csv" class="btn btn-success"> Demo file</a>
                            </legend>
                            <div class="control-group">
                                <div class="controls m-4">
                            ...
                            <div class="control-group">
                                <div class="controls">
                                    <button type="submit" id="submit" name="Import"
                                        class="btn btn-primary button-loading btn-lg m-4"
                    ...
                    <div class="col-lg-7">
                        <form action="add_new_user.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="rno" class="form-control" id="formGroupExampleInput"
                                    placeholder="Roll No.">
                            </div>
                            <div class="form-group">
                            ...
                            <button type="submit" id="submit" name="Import"
                                class="btn btn-success btn-lg m-4">Save</button>
                        </form>
                    </div>
                </div>
