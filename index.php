 ...
 <body>
     ...
     <section id="hero" class="coding_bg d-flex justify-content-center align-items-center">
         <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
             <h1>Contribution the product or service</h1>
             <h2>Easily establish how/which related products should be displayed to attract customers in the best way..
             </h2>
             <a href="#availableQuizes" class="btn-get-started">Shopping</a>
         </div>
     </section><!-- End Hero -->
                             ...
                             <div class="card shadow-sm border-0 rounded">
                                 <div class="card-body p-0">
                                     ...
                                     <div class="p-4">
                                         ...
                                         <h6>Prize: <samp
                                                 style="color:red"><?php echo "Price: ".$row["pprice"] ?></samp></h6>
                                         <a href="tel:<?php $row["scontact"] ?>"> <button type="button"
                                                 class="btn btn-success">Buy Now</button></a>
                                         <form action="View.php" method="POST">
                                             <input type="hidden" name="id" value="<?php echo $row['pid'] ?>">
                                             <button type="submit" class=" mt-3 text-right float-right" name="View"
